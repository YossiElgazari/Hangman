  ...
  >
      ...
      >
        ...
        <div>
          ...
          <VolumeControl label="Music" volume={settings.volume} onVolumeChange={(volume) => updateSettings({ volume })} />
          <VolumeControl label="Sound Effects" volume={settings.soundEffectsVolume} onVolumeChange={(soundEffectsVolume) => updateSettings({ soundEffectsVolume })} />
