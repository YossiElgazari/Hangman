      ...
      <div className="flex items-center">
        <div className="progress mx-3 relative w-full h-4">
          ...
          <input
            ...
            max="100"
            value={volume}
            onChange={(e) => onVolumeChange(parseInt(e.target.value))} // Update volume on change
        ...
        <span className="w-12 text-center text-secondary dark:text-secondary_dark font-bold">
          {volume}% {/* Display the current volume percentage */}
        </span>
      </div>
    </div>
  );
